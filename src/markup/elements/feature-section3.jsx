					...
					<div className="container">
						<div className="heading-bx text-center">
								<div className="col-lg-6 mb-30"></div>
									...
									<p>Aprender inglês é se comunicar, entender culturas e explorar novas possibilidades.</p>
								</div>
								</div>
						...
						<div className="row">
							...
							<div className="col-xl-3 col-sm-6 mb-30">
								<div className="feature-container feature-bx3">
									...
									<p>Metodologia internacional e comunicativa, com foco na conversação e prática real do inglês.</p>
								</div>
							</div>
							<div className="col-xl-3 col-sm-6 mb-30">
								<div className="feature-container feature-bx3">
									...
									<p>O inglês é aprendido de forma significativa, dinâmica e personalizada, respeitando seu ritmo.</p>
								</div>
							</div>
							<div className="col-xl-3 col-sm-6 mb-30">
								<div className="feature-container feature-bx3">
									...
									<p>Uso de ferramentas digitais e tecnologia para tornar a aprendizagem mais imersiva e eficaz.</p>
								</div>
							</div>
							<div className="col-xl-3 col-sm-6 mb-30">
								<div className="feature-container feature-bx3">
									...
									<p>Trabalhamos fala, escuta, leitura e escrita, sempre com interação como ponto central.</p>
								</div>
							</div>
